...
const EvaluationCard = ({ title, body }: EvaluationCardProps) => {
  ...
  return (
    <>
      ...
      <div className="hidden  max-w-[630px] min-w-[328px] h-[341px] pb-[30px] pt-[42px] px-3 relative bg-white rounded-xl border-2 overflow-hidden h-desktop:inline-flex flex-col items-start">
        <svg className="absolute w-0 h-0" aria-hidden>
          <clipPath id={clipId} clipPathUnits="objectBoundingBox">
      ...
      <div className="w-full max-w-[1024px] min-w-[630px] min-h-[145px] pl-3 pr-12 py-3 bg-white rounded-xl overflow-hidden border-2 inline-flex flex-col h-desktop:hidden">
        <div className="self-stretch inline-flex justify-start items-center h-[121px] gap-2 my-2">
          ...
          <div className="pl-7flex-1 min-w-[292px] text-zinc-800 text-base pl-[30px] font-normal font-['Poppins'] leading-relaxed max-w-full h-fit">
            {body}
          </div>
        </div>
      </div>
